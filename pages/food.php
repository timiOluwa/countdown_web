...
?>
      ...
      <main>
        <p class="h1 ps-5 pt-2 text-black tech fw-bold">Food and Drink Connoiseuurs</p>
        ...
        <section>
          ...
          <div class="first-section">
              <h4>Set the date and time of the Event </h4>
                ...
                <form id="eventForm" method="POST" action="../app/food/save_event.php">
