...
?>
      ...
      <main class="">
        <p class="h1 ps-5 pt-2 text-black tech fw-bold">Music Festival enthusiast</p>
        ...
        <section>
          ...
          <div class="first-section">
              <h4>Set the date and time of the Event </h4>
                ...
                <form id="eventForm" method="POST" action="../app/musics/save_event.php">
    ...
    function updateCountdown() {
        ...
        fetch('../app/musics/get_event.php')
